...
class Graph {
    private:
        ...
        //keys: hashvalue of label element: Node pointer
        unordered_map< unsigned int, Node*> nodes_map;
    ...
    public:
         ...
         */
        unsigned int hash_function(string label);
        ...
        /*
         * Returns all of the graph's edges in a priority queue which ranks smaller edge weights
         * as higher priority
         */
        vector<tuple<string, string, double>> get_edges();
         ...
         */
        Node* find_node(string node_label);
...
class EdgePtrComp{
    public:
        bool operator()(tuple<Node*, Node*, double> lhs, tuple<Node*, Node*, double> rhs) const;
};

class EdgeTupleComp{
    public:
        //bool operator()(tuple<string, string, double> lhs, tuple<string, string, double> rhs) const;
